...
<section class="propagation">
  ...
  <div class="propagation-widget">
    ...
    <p class="prop-last-updated grayline-hint" id="grayline-hint">
      Calculating grayline hint...
    </p>
  </div>
  ...
  <div class="prop-grid smart-bands" id="smart-bands">
    ...
    <div class="prop-card band-card" data-band="12m">
      <div class="band-card-header">
        <h3>12m</h3>
        <span class="band-badge" id="badge-12m">Loading</span>
      </div>
      <p class="prop-note" id="note-12m">Evaluating current conditions...</p>
    </div>
    ...
    <div class="prop-card band-card" data-band="17m">
      <div class="band-card-header">
        <h3>17m</h3>
        <span class="band-badge" id="badge-17m">Loading</span>
      </div>
      <p class="prop-note" id="note-17m">Evaluating current conditions...</p>
    </div>
    ...
    <div class="prop-card band-card" data-band="30m">
      <div class="band-card-header">
        <h3>30m</h3>
        <span class="band-badge" id="badge-30m">Loading</span>
      </div>
      <p class="prop-note" id="note-30m">Evaluating current conditions...</p>
    </div>
